<template>
  <div class="container">
    <div class="card-header px-0 mt-2 bg-transparent clearfix">
      <h4 class="float-left pt-2">Transactions</h4>
      ...
      <table class="table table-hover">
        <thead>
          <tr>
            ...
            <th>
              ...
              <i class="mr-1 fas" :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'amount' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'amount' && filters.orderBy.direction == 'desc'}"></i>
            </th>
        ...
        <tbody>
          <tr v-for="topup in topups">
            ...
            <td>
               {{topup.debit!=0?-(topup.debit):topup.credit}}
            </td>
...
export default {
  ...
  methods: {
    getAgentsTopup () {
      ...
      axios.post(`/api/users/transactions?page=${this.filters.pagination.current_page}`, this.filters)
      .then(response => {
