    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9 col-xl-7">
        ...
        <div class="card-body px-0">
          ...
          <div class="form-group">
            <label>Balance</label>
            <input type="numeric" class="form-control" :class="{'is-invalid': errors.balance}" v-model="user.balance">
            <div class="invalid-feedback" v-if="errors.balance">{{errors.balance[0]}}</div>
          </div>
          <div class="form-group">
            <label>Roles</label>
            <multiselect
